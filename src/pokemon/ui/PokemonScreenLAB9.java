...
public class PokemonScreenLAB9 extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		currentPosx =  (ran.nextInt(W/STEP_SIZE)+1)*STEP_SIZE; // this should be a random position
		currentPosy = (ran.nextInt(H/STEP_SIZE)+1)*STEP_SIZE;; // this should be a random position
		pokeImage = (new Image(new File("icons/pikachu.gif").toURI().toString()));
		pokemon = new ImageView(pokeImage);
		...
		mapGroup.getChildren().add(pokemon);
