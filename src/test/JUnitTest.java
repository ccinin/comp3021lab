...
public class JUnitTest {
	...
	public void countLetters() {
        TextNote a = new TextNote("aaaaa", "bbb");
        Character output = a.countLetters();
        Character expect = 'a'; 
		assertEquals("The results is not match", expect, output);
		
		TextNote b = new TextNote("c", "n");

	        Character outputs = b.countLetters();
	        Character expects = 'c';
	       
			assertEquals("The results is not match", expects, outputs);
